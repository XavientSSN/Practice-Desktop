 ...
 * @author vkvarma
 */
public class SSNChangePasswordService {

    private static String REST_ENDPOINT = "";
    private HttpURLConnection con = null;
    private SSNChangePasswordRequest request = null;
    private SSNChangePasswordResponse response = null;
    private String hostName = "";
    private String serviceName = "";
    private String restURI = "";
    final    private Logger logger = Logger.getLogger(SSNChangePasswordService.class);
    public SSNChangePasswordService() {
    }
    ...
    public void initWSConnection() {
        ...
        if (this.getCon() == null) {
            ...
            SSNMessageDialogBox s= new SSNMessageDialogBox();
            s.initDialogBoxUI(SSNDialogChoice.NOTIFICATION_DIALOG.getType(), "", "Connection Down", "Connection Failed");
        }
    }
    ...
    public void prepareRequest(SSNChangePasswordRequest request) {
        try {
            if (request != null) {
    ...
    private void sendRequest() {
        try {
            if (getCon().getResponseCode() != 200) {
                //JOptionPane.showMessageDialog(null, getCon().getResponseMessage(), "No Response From Service", JOptionPane.ERROR_MESSAGE);
            ...
            //JOptionPane.showMessageDialog(null, "Null Response", "No Response From Service", JOptionPane.ERROR_MESSAGE);
            SSNMessageDialogBox dialogBox = new SSNMessageDialogBox();
            dialogBox.initDialogBoxUI(SSNDialogChoice.NOTIFICATION_DIALOG.getType(), "No Response From Service", "", "Server Down");
        }
    }
    ...
    private void processResponse() {
        ...
        String jsonResponseStr = responseStr.toString();
        Gson gson = new GsonBuilder().setPrettyPrinting().create();
        this.setResponse(gson.fromJson(jsonResponseStr, SSNChangePasswordResponse.class));
    }
  ...
  //  public void setLoginForm(SSNLoginForm loginForm) {
    ...
    public SSNChangePasswordRequest getRequest() {
        return request;
    }

    public void setRequest(SSNChangePasswordRequest request) {
        this.request = request;
    }

    public SSNChangePasswordResponse getResponse() {
        return response;
    }

    public void setResponse(SSNChangePasswordResponse response) {
