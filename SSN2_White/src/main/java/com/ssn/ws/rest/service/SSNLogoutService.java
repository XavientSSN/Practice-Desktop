 ...
 * @author vkvarma
 */
public class SSNLogoutService {

    private static String REST_ENDPOINT = "";
    private HttpURLConnection con = null;
    private SSNLogoutRequest request = null;
    private SSNLogoutResponse response = null;
    private SSNHomeForm homeForm = null;
    private String hostName = "";
    private String serviceName = "";
    private String restURI = "";
    final    private Logger logger = Logger.getLogger(SSNLogoutService.class);

    public SSNLogoutService() {
    }
    ...
    public void initWSConnection() {
        ...
        if (this.getCon() == null) {
            //JOptionPane.showMessageDialog(this.getHomeForm(), "Connection Down", "Connection Failed", JOptionPane.ERROR_MESSAGE);
    ...
    public void prepareRequest(SSNLogoutRequest request) {
        try {
            if (request != null) {
                ...
                //JOptionPane.showMessageDialog(this.getHomeForm(), "Invalid Request", "Not Enough Request Data", JOptionPane.ERROR_MESSAGE);
                SSNMessageDialogBox dialogBox = new SSNMessageDialogBox();
    ...
    private void sendRequest() {
        try {
            if (getCon().getResponseCode() != 200) {
                //JOptionPane.showMessageDialog(this.getHomeForm(), getCon().getResponseMessage(), "No Response From Service", JOptionPane.ERROR_MESSAGE);
                SSNMessageDialogBox dialogBox = new SSNMessageDialogBox();
            ...
            //JOptionPane.showMessageDialog(this.getHomeForm(), "Null Response", "No Response From Service", JOptionPane.ERROR_MESSAGE);
            SSNMessageDialogBox dialogBox = new SSNMessageDialogBox();
    ...
    private void processResponse() {
        ...
        this.setResponse(gson.fromJson(jsonResponseStr, SSNLogoutResponse.class));
    }
    ...
    public SSNLogoutRequest getRequest() {
        return request;
    }

    public void setRequest(SSNLogoutRequest request) {
        this.request = request;
    }

    public SSNLogoutResponse getResponse() {
        return response;
    }

    public void setResponse(SSNLogoutResponse response) {
