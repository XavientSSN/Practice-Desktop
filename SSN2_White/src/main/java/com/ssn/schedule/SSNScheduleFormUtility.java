...
public class SSNScheduleFormUtility {
    /**
    ...
    static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(SSNScheduleFormUtility.class);
    public SSNScheduleFormUtility() {
    ...
    public void addLastVerticalStruts(Component c, Container parent) {
        GridBagLayout gbl = (GridBagLayout) parent.getLayout();
        gbl.setConstraints(c, lastConstraints);
...
public void addLastHorizentalStruts(Component c, Container parent) {
        GridBagLayout gbl = (GridBagLayout) parent.getLayout();
        gbl.setConstraints(c, lastConstraints);
